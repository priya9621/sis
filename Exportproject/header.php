...
<?php require_once '../config.php'?>
    ...
    <header class="md-4">
        <nav class="navbar navbar-expand-md navbar-light bg-dark">
            <a href="<?php echo base_url; ?>Exportproject/school-project/index.php" class="navbar-brand py-2 md-2">
            ...
            <?php if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] === true) { ?>                  
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item p-2">
                        <a class="nav-link text-light text-uppercase font-weight-bold py-3" href="<?php echo base_url; ?>./Exportproject/std-select-sch.php">Student</a>
                    </li>                     
                </ul> 
